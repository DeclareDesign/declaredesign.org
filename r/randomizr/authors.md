...
- **Neal Fultz**. Contributor.  
  C version of restricted partitions

- **Graeme Blair**. Contributor.
  [](https://orcid.org/0000-0001-9164-2102)

## Citation

Source:
[`DESCRIPTION`](https://github.com/DeclareDesign/randomizr/blob/main/DESCRIPTION)

Coppock A (2025). *randomizr: Easy-to-Use Tools for Common Forms of
Random Assignment and Sampling*. R package version 1.0.0,
