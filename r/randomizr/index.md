...
[`complete_ra()`](https://declaredesign.org/r/randomizr/reference/complete_ra.md)
(Complete randomization) is the function that will be most appropriate
for a large number of experimental situations: when you want to assign a
fixed `m` units out of a population of `N` units to treatment:
...
of clusters to three different treatments, makes use of
[`cluster_ra()`](https://declaredesign.org/r/randomizr/reference/cluster_ra.md)
