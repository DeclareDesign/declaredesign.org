...
slug: "2019-02-05-instrumental-variables"
date: 2019-02-19
output:
  html_document:
    highlight: tango
...
```{r}
#| fig-cap: "Figure: DAG for a non-randomized instrument. Z is an instrument for the effect of X on Y"
#| echo: false
hj_dag(x = 1:5, 
       y = c(0,1,0,1,0), 
...
ggplot(gg_df, aes(path_weight, bias, color = inquiry)) +
  geom_point() +
  geom_line() +
  geom_label_repel(data = label_df, aes(label = inquiry)) +
